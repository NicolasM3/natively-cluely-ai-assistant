...
export {
  ...
  LIVE_LOCAL_FIRST_USEFUL_TIMEOUT_MS, LIVE_LOCAL_MEDIUM_FIRST_USEFUL_TIMEOUT_MS,
  LIVE_LOCAL_LARGE_FIRST_USEFUL_TIMEOUT_MS, LIVE_LOCAL_TOTAL_HARD_TIMEOUT_MS,
  localFirstUsefulTimeoutMs, localTotalHardTimeoutMs,
